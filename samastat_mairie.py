...
GEOJSON_PATH = "commune_boundaries.geojson"
...
def show_main_app():
    ...
    coords = COORDINATES[selected_commune]
    ...
    popup_text = f"{selected_commune}<br>Population : {data['Population']:,}<br>Vaccination : {data['Taux Vaccination (%)']}%"
    ...
    if os.path.exists(GEOJSON_PATH):
        ...
        folium.GeoJson(
            ...
            style_function=lambda x: {"fillColor": "lightblue", "color": "gray", "fillOpacity": 0.4}
        ).add_to(m)
